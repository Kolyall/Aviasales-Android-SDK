...
public class CircleProgressView extends View {
    ...
    private void showTextView(boolean mIsTextEnabled) {
        mTextView.setText(getTextPrefix() +
                String.valueOf(Math.round(mProgress))+getTextSuffix());
    ...
    public void setProgress(float progress) {
        ...
        mTextView.setText(getTextPrefix() + String.valueOf(Math.round(mProgress)) + getTextSuffix());
        showTextView(mIsTextEnabled);
        invalidate();
    ...
    public void setProgressWithAnimation(final float progress, int duration) {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                mTextView.setText(getTextPrefix() +
                        String.valueOf(Math.round((Float) animation.getAnimatedValue())) + getTextSuffix());
            }
        });
