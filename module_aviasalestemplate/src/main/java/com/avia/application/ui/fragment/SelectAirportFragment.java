...
import com.avia.application.ui.adapter.SelectAirportAdapter;
import com.avia.application.ui.adapter.SelectAirportInfoAdapter;
import com.avia.application.ui.listener.OnPlaceSelectedListener;
			...
			public void run() {
				AviasalesSDK.getInstance().startPlacesSearch(setSearchByNameParams(), new OnSearchPlacesListener() {
					...
					public void onSuccess(List<PlaceData> placeDates) {
						...
						activity.runOnUiThread(updatePlaces);
					}
