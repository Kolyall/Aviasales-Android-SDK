...
public class OldAndroidDatePickerDialog extends DatePickerDialog {
    ...
    public OldAndroidDatePickerDialog(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, Calendar minDate, Calendar maxDate) {
